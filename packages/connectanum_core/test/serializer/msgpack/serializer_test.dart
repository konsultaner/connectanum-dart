...
void main() {
  ...
  group('serialize', () {
    test('Hello', () {
      final encoded = serializer.serialize(
        Hello('my.realm', Details.forHello()),
      );
      expect(
    ...
    test('Call serializes isolate-transferred binary payloads', () {
      final call = Call(
        7814135,
        'com.myapp.encrypted',
        arguments: [
      ...
      final frame =
          msgpack_dart.deserialize(serializer.serialize(call)) as List<dynamic>;
    ...
    test('Hello with auth information', () {
      final authHello = Hello('my.realm', Details.forHello());
      ...
      final encoded = serializer.serialize(authHello);
      expect(
        msgpack_dart.deserialize(encoded),
        equals(
          expectedHelloWire(
      ...
      expect(
        serializer.serialize(
          Event(
            ...
            5512315355,
            EventDetails(publisher: 1231412, topic: 'de.de.com', trustlevel: 1),
            arguments: ['johnny'],
        ...
        equals(
          Uint8List.fromList([
            // Fixed array header, event code, subscription and uint64 publication.
            0x96, 36, 36, 0xcf, 0, 0, 0, 1, 72, 143, 65, 219,
            ...msgpack_dart.serialize({
              'publisher': 1231412,
              'topic': 'de.de.com',
              'trustlevel': 1,
            }),
            ...msgpack_dart.serialize(['johnny']),
            ...msgpack_dart.serialize({'firstname': 'John', 'surname': 'Doe'}),
          ]),
        ),
      );
    });
    test('Subscribe', () {
      ...
      expect(
        ...
        isA<Uint8List>().having(
          msgpack_dart.deserialize,
          'decoded WAMP fields (map order is not significant)',
          equals([
            32,
            713845233,
            {
    ...
    test('Goodbye', () {
      expect(
        ...
        equals(
          Uint8List.fromList([
            ...
            46, 99, 108, 111, 115, 101, 46, 103, 111, 111, //
      ...
      expect(
        ...
        equals(
          Uint8List.fromList([
            147, 6, 128, 182, 119, 97, 109, 112, 46, 99, 108, //
            111, 115, 101, 46, 99, 108, 111, 115, 101, 95, 114, //
            101, 97, 108, 109,
          ]),
        ),
      );
      expect(
        ...
        equals(
          Uint8List.fromList([
            147, 6, 128, 186, 119, 97, 109, 112, 46, 99, //
            108, 111, 115, 101, 46, 115, 121, 115, 116, 101, //
  ...
  group('deserialize', () {
    ...
    test('Error', () {
      var toDeserialize = serializer.serialize(
        Error(MessageTypes.codeHello, 678887, {
          'detail1': [2, 4134],
      ...
      toDeserialize = serializer.serialize(
        Error(
          MessageTypes.codeHello,
          678887,
          {},
      ...
      expect(err.arguments, isNotNull);
      expect(
        err.argumentsKeywords,
        containsPair('name', 'must be konsultaner'),
      );
    });
    test('Challenge', () {
      var challenge =
  ...
  group('deserialize lazy payloads', () {
    test('Result retains lazy MsgPack payload slices on decode', () {
      ...
      expect(result.arguments!.first, isA<Uint8List>());
      expect(
  ...
  group('string conversion', () {
    test('convert UTF-8', () {
      ...
      expect(
        deserializedInvocation.arguments![0],
