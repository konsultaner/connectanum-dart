...
final class CtRouterMetricsInfo extends ffi.Struct {
  ...
  @ffi.Uint64()
  external int responseStreamHeadersToFirstConnectionWriteSamplesTotal;

  @ffi.Uint64()
  external int responseStreamHeadersToFirstConnectionWriteUsTotal;

  @ffi.Uint64()
  external int responseStreamHeadersToFirstConnectionWriteGe1msTotal;

  @ffi.Uint64()
  external int responseStreamHeadersToFirstConnectionWriteGe5msTotal;

  @ffi.Uint64()
  external int responseStreamHeadersToFirstConnectionWriteGe10msTotal;
  ...
  @ffi.Uint64()
  external int responseStreamTailChunkChannelWaitSamplesTotal;

  @ffi.Uint64()
  external int responseStreamTailChunkChannelWaitUsTotal;

  @ffi.Uint64()
  external int responseStreamTailChunkChannelWaitGe1msTotal;

  @ffi.Uint64()
  external int responseStreamTailChunkChannelWaitGe5msTotal;

  @ffi.Uint64()
  external int responseStreamTailChunkChannelWaitGe10msTotal;

  @ffi.Uint64()
  external int responseStreamTailChunkSendCallSamplesTotal;

  @ffi.Uint64()
  external int responseStreamTailChunkSendCallUsTotal;

  @ffi.Uint64()
  external int responseStreamTailChunkSendCallGe1msTotal;

  @ffi.Uint64()
  external int responseStreamTailChunkSendCallGe5msTotal;

  @ffi.Uint64()
  external int responseStreamTailChunkSendCallGe10msTotal;

  @ffi.Uint64()
  external int responseStreamFirstToLastChunkSendSamplesTotal;

  @ffi.Uint64()
  external int responseStreamFirstToLastChunkSendUsTotal;

  @ffi.Uint64()
  external int responseStreamFirstToLastChunkSendGe1msTotal;

  @ffi.Uint64()
  external int responseStreamFirstToLastChunkSendGe5msTotal;
  ...
  @ffi.Uint64()
  external int requestBodyStreamRemainingTailDataWaitSamplesTotal;

  @ffi.Uint64()
  external int requestBodyStreamRemainingTailDataWaitUsTotal;

  @ffi.Uint64()
  external int requestBodyStreamRemainingTailDataWaitMaxUsTotal;

  @ffi.Uint64()
  external int requestBodyStreamRemainingTailDataWaitMaxEventIndexTotal;

  @ffi.Uint64()
  external int requestBodyStreamRemainingTailDataWaitMaxBytesBeforeTotal;

  @ffi.Uint64()
  external int requestBodyStreamRemainingTailDataWaitMaxBytesAfterTotal;
