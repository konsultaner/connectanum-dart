...
import 'package:connectanum_dart/connectanum.dart';
import 'package:connectanum_dart/json.dart';
...
void main() async {
  ...
  final client1 = Client(
      ...
      transport: WebSocketTransport(
        ...
        // from package:connectanum_dart/msgpack.dart and use WebSocketSerialization.SERIALIZATION_MSGPACK
        Serializer(),
