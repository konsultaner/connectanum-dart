...
class Ppk {
  ...
  static Uint8List loadPrivateKeyFromPpk(
    ...
    if (privateKey.isNotEmpty) {
      ...
      if (encrypted) {
        ...
        privateKeyDecrypted = decodePpkPrivateKey(
  ...
  static void ppkMacCheck(
    ...
    var sha1Hash = SHA1Digest()
      ..update(
        Uint8List.fromList('putty-private-key-file-mac-key'.codeUnits),
        0,
        'putty-private-key-file-mac-key'.codeUnits.length,
      );
    if (password != null) {
      sha1Hash.update(
        Uint8List.fromList(password.codeUnits),
    ...
    mac.update(
      Uint8List.fromList([0, 0, 0, macData.comment.codeUnits.length]),
      0,
      4,
    );
