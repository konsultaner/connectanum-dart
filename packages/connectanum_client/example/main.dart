...
void main() async {
  ...
  final client1 = Client(
    ...
    transport: WebSocketTransport(
      ...
      // from package:connectanum_client/msgpack.dart and use WebSocketSerialization.SERIALIZATION_MSGPACK
      Serializer(),
  ...
  try {
        ...
        .connect(
          options: ClientConnectOptions(
            ...
            reconnectTime: Duration(
              milliseconds: 200,
            ), // default is null, so immediately
    ...
    registered.onInvoke(
      (invocation) => invocation.respondWith(arguments: ['1.1.0']),
    );
