...
class Error extends AbstractMessageWithPayload {
    ...
    static final String ERROR_INVOCATION_CANCELED = "wamp.error.invocation_canceled";
    // INTERACTION ERRORS
    ...
    static final String WRONG_MESSAGE_STRUCTURE  = "wamp.error.wrong_message_structure";
    static final String NO_SUCH_PROCEDURE        = "wamp.error.no_such_procedure";
    static final String PROCEDURE_ALREADY_EXISTS = "wamp.error.procedure_already_exists";
