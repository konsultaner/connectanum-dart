...
deployment plan. When no local or GitHub RC tag points at the checked-out head,
the same view also inventories existing local and GitHub RC tags and reports
whether each one is stale for the current candidate.
