...
Last reviewed branch checkpoint: MCP auth-grant direct JSON coverage.
Latest fully clean hosted checkpoint: Commit `a60d432`.
...
WebSocket smoke. The latest fully clean hosted checkpoint remains `a60d432`
