...
`6b48a82`
(`test: cover mcp active direct json auth`; hosted CI evidence
clean).
Current implementation checkpoint: MCP consumer active direct JSON batch auth
smoke (complete; local verification clean; hosted evidence pending).
Latest implementation checkpoint: MCP consumer active direct JSON auth smoke
(complete; hosted CI evidence clean).
