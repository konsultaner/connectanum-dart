...
- Hosted GitHub evidence for `a3a7c96` is clean: `CI` run `25299738068`
  ...
  run `25299738064` completed successfully and covers the checked-out head,
...
Complete. Commit `a3a7c96` was pushed to both remotes and the hosted GitHub
