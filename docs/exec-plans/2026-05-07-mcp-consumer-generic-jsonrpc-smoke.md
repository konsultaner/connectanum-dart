...
- Commit `0a13551` (`test: cover mcp generic jsonrpc smoke`) was pushed to
  `origin/add-router` and `github/add-router` on 2026-05-07.
- Hosted GitHub `CI` run `25494035617` for `0a13551` completed successfully on
...
Complete with local and hosted evidence. Implementation commit `0a13551` was
