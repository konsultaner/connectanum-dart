...
- 2026-06-13: Extended the installed router CLI generated Dart consumer smoke
  ...
  until push; latest clean hosted evidence remains `832d5a1`: GitHub `master` CI `27454283637` passed with `Fast
  Checks` and `Full Verify` clean, GitHub `add-router` CI `27454281467` also
