...
- 2026-06-13: Extended the installed router CLI generated Dart consumer smoke
  ...
  smoke. Hosted evidence for this checkpoint is pending until push; the latest
  fully clean hosted checkpoint remains `13d0025`: GitHub `master` CI
  ...
  policy: no numeric RC tag points at `13d0025`, no GitHub prerelease or
  router image RC tag is selected, and pub.dev package
