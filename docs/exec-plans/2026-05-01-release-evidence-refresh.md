...
- Local branch head is `7cae4ef`.
- GitHub `CI` run `25192999135` passed for `7cae4ef`.
- `Dart Package Publish Dry Run` run `25192039083` and `Native Artifacts` dry-run
  `25192553399` remain relevant because only docs changed after `4267e7a`.
...
- Completed after a clean local `bin/verify`. Remaining release/RC blockers are
  unchanged and operator-owned: branch protection required checks, router image
