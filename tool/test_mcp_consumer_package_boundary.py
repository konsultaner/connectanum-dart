...
class McpConsumerPackageBoundaryTest(unittest.TestCase):
    ...
    def test_mcp_consumer_smoke_exercises_mrtr_form_elicitation(self) -> None:
        ...
        self.assertIn("grant.isForMcpEndpoint(endpoint)", body)
        self.assertIn("endpoint.replace(port: endpoint.port + 1)", body)
        self.assertIn("authorized another origin", body)
    ...
    def test_bench_cli_consumer_smoke_uses_package_executable(self) -> None:
        ...
        self.assertIn("router_bench_port", body)
        self.assertIn("router-bench-scenario.yaml", body)
        self.assertIn("installed_router_bench_rawsocket_rpc", body)
        self.assertIn("type: wamp_rawsocket_rpc", body)
        self.assertIn('PATH="$pub_cache/bin:$PATH" PUB_CACHE="$pub_cache" router_bench \\', body)
        self.assertIn('--scenario "$smoke_dir/router-bench-scenario.yaml"', body)
        self.assertIn("'WAMP samples: 1'", body)
        self.assertIn("'WAMP request bytes: 16'", body)
    ...
    def test_public_router_hosted_client_example_uses_public_io_entrypoint(
        ...
        for public_helper in (
            ...
            "direct-batch-wamp-session-count",
            "direct-batch-wamp-session-list",
            "direct-batch-wamp-session-get",
            "direct-batch-wamp-configured-registration-lookup",
            "direct-batch-wamp-configured-registration-match",
            "direct-batch-wamp-configured-registration-list",
            ...
            "direct-batch-wamp-configured-subscription-lookup",
            "direct-batch-wamp-configured-subscription-match",
            "direct-batch-wamp-configured-subscription-list",
            ...
            "directJsonStaleSessionId",
            "sessionUnchanged",
            "catalog did not include $uri.",
            "did not advertise $value.",
            ...
            "Direct JSON WAMP session metadata",
            ...
            "Direct JSON batch WAMP session metadata",
            "Direct JSON batch configured WAMP registration metadata",
            "Direct JSON batch configured WAMP subscription metadata",
            ...
            "Streamable active direct JSON WAMP session metadata",
            ...
            "streamable-active-direct-resource-templates",
            ...
            "streamable-active-direct-wamp-session-list",
            "streamable-active-direct-wamp-session-get",
            "streamable-active-direct-wamp-procedure-api-list",
            "streamable-active-direct-wamp-procedure-api-list-method",
            "streamable-active-direct-wamp-procedure-api-describe",
            "streamable-active-direct-wamp-procedure-api-describe-method",
            "streamable-active-direct-wamp-topic-api-list",
            "streamable-active-direct-wamp-topic-api-list-method",
            "streamable-active-direct-wamp-topic-api-describe",
            "streamable-active-direct-wamp-topic-api-describe-method",
            ...
            "streamable-active-direct-wamp-configured-registration-get",
            ...
            "streamable-active-direct-wamp-configured-subscription-get",
            ...
            "streamable-active-direct-batch-wamp-session-count",
            "streamable-active-direct-batch-wamp-session-list",
            "streamable-active-direct-batch-wamp-session-get",
            ...
            "Streamable active direct JSON batch WAMP session metadata",
            ...
            "countWampSessionsDirect",
            "listWampSessionsDirect",
            "getWampSessionDirect",
            "lookupWampRegistrationDirect",
            "matchWampRegistrationDirect",
            "listWampRegistrationsDirect",
            "getWampRegistrationDirect",
            "listWampRegistrationCalleesDirect",
            ...
            "streamable-active-direct-pubsub-publish",
            "streamable-active-direct-pubsub-publish-poll",
            "streamable-active-direct-pubsub-publish-method",
    ...
    def test_public_router_hosted_client_paginates_selected_catalog_entries(
        ...
        for expected in (
            ...
            "_advertisedTool",
            "directStandardToolPagesRead",
            "directToolPagesRead",
            "directToolMethodPagesRead",
            ...
            "activeDirectToolPagesRead",
            "activeDirectToolMethodPagesRead",
