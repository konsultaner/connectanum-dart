...
class KtlsHttp2CompareTest(unittest.TestCase):
    ...
    def test_repeat_stability_surfaces_sign_consistent_phase_signals(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self._write_summary(
                ...
                [
                    self._row(
                        ...
                        response_body_tail_connection_inter_read_gap_max_read_index_avg=2.0,
            ...
            self._write_summary(
                ...
                [
                    self._row(
                        ...
                        response_body_tail_connection_inter_read_gap_max_read_index_avg=3.0,
            ...
            self._write_summary(
                ...
                [
                    self._row(
                        ...
                        response_body_tail_connection_inter_read_gap_max_read_index_avg=2.5,
            ...
            self._write_summary(
                ...
                [
                    self._row(
                        ...
                        response_body_tail_connection_inter_read_gap_max_read_index_avg=3.5,
            ...
            self.assertIn(
                "Tail conn max-gap bytes-before avg | 2 | kTLS higher | "
                "32000.00 B..33000.00 B (median 32500.00 B) | "
                "48000.00 B..50000.00 B (median 49000.00 B) | "
                "+16000.00 B..+17000.00 B (median +16500.00 B)",
                markdown,
            )
            self.assertIn(
                "Tail conn max-gap byte-position ratio avg | 2 | kTLS higher | "
    ...
    def _row(
        ...
        *,
        ...
        response_body_tail_connection_read_bytes_samples_total: int | None = 16,
        response_body_tail_connection_read_bytes_avg: float | None = 65536.0,
        response_body_tail_connection_read_bytes_p95: float | None = 65536.0,
        response_body_tail_connection_read_size_avg_samples_total: int | None = 16,
        response_body_tail_connection_read_size_avg: float | None = 16384.0,
        response_body_tail_connection_read_size_p95: float | None = 32768.0,
        response_body_tail_connection_read_size_max_samples_total: int | None = 16,
        response_body_tail_connection_read_size_max_avg: float | None = 32768.0,
        response_body_tail_connection_read_size_max_p95: float | None = 65536.0,
        response_body_tail_connection_inter_read_gap_avg_samples_total: int | None = 16,
        response_body_tail_connection_inter_read_gap_avg_ms: float | None = 0.2,
        response_body_tail_connection_inter_read_gap_p95_ms: float | None = 0.3,
        response_body_tail_connection_inter_read_gap_max_samples_total: int | None = 16,
        response_body_tail_connection_inter_read_gap_max_avg_ms: float | None = 0.4,
        response_body_tail_connection_inter_read_gap_max_p95_ms: float | None = 0.6,
        response_body_tail_connection_inter_read_gap_max_position_samples_total: int | None = 16,
        response_body_tail_connection_inter_read_gap_max_read_index_avg: float | None = 3.0,
        response_body_tail_connection_inter_read_gap_max_read_index_p95: float | None = 5.0,
        response_body_tail_connection_inter_read_gap_max_bytes_before_avg: float | None = 32768.0,
        response_body_tail_connection_inter_read_gap_max_bytes_before_p95: float | None = 65536.0,
        response_body_tail_connection_inter_read_gap_max_bytes_after_avg: float | None = 32768.0,
        ...
        return {
            ...
            "http_phase_timing": (
                ...
                if stream_acquire_wait_avg_ms is None
                    ...
                    "response_body_tail_connection_read_bytes_samples_total": response_body_tail_connection_read_bytes_samples_total,
                    "response_body_tail_connection_read_bytes_avg": response_body_tail_connection_read_bytes_avg,
                    "response_body_tail_connection_read_bytes_p95": response_body_tail_connection_read_bytes_p95,
                    "response_body_tail_connection_read_size_avg_samples_total": response_body_tail_connection_read_size_avg_samples_total,
                    "response_body_tail_connection_read_size_avg": response_body_tail_connection_read_size_avg,
                    "response_body_tail_connection_read_size_p95": response_body_tail_connection_read_size_p95,
                    "response_body_tail_connection_read_size_max_samples_total": response_body_tail_connection_read_size_max_samples_total,
                    "response_body_tail_connection_read_size_max_avg": response_body_tail_connection_read_size_max_avg,
                    "response_body_tail_connection_read_size_max_p95": response_body_tail_connection_read_size_max_p95,
                    "response_body_tail_connection_inter_read_gap_avg_samples_total": response_body_tail_connection_inter_read_gap_avg_samples_total,
                    "response_body_tail_connection_inter_read_gap_avg_ms": response_body_tail_connection_inter_read_gap_avg_ms,
                    "response_body_tail_connection_inter_read_gap_p95_ms": response_body_tail_connection_inter_read_gap_p95_ms,
                    "response_body_tail_connection_inter_read_gap_max_samples_total": response_body_tail_connection_inter_read_gap_max_samples_total,
                    "response_body_tail_connection_inter_read_gap_max_avg_ms": response_body_tail_connection_inter_read_gap_max_avg_ms,
                    "response_body_tail_connection_inter_read_gap_max_p95_ms": response_body_tail_connection_inter_read_gap_max_p95_ms,
                    "response_body_tail_connection_inter_read_gap_max_position_samples_total": response_body_tail_connection_inter_read_gap_max_position_samples_total,
                    "response_body_tail_connection_inter_read_gap_max_read_index_avg": response_body_tail_connection_inter_read_gap_max_read_index_avg,
                    "response_body_tail_connection_inter_read_gap_max_read_index_p95": response_body_tail_connection_inter_read_gap_max_read_index_p95,
                    "response_body_tail_connection_inter_read_gap_max_bytes_before_avg": response_body_tail_connection_inter_read_gap_max_bytes_before_avg,
                    "response_body_tail_connection_inter_read_gap_max_bytes_before_p95": response_body_tail_connection_inter_read_gap_max_bytes_before_p95,
                    "response_body_tail_connection_inter_read_gap_max_bytes_after_avg": response_body_tail_connection_inter_read_gap_max_bytes_after_avg,
