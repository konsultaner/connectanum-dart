...
PHASE_TIMING_SUMMARY_KEYS = (
    ...
    (
        ...
        "Response headers last-write-to-first-read samples",
    ),
    (
        "response_headers_last_write_to_first_read_avg_ms",
        "Response headers last-write-to-first-read avg",
    ),
    (
        "response_headers_last_write_to_first_read_p95_ms",
        "Response headers last-write-to-first-read p95",
    ),
    ...
    (
        ...
        "Response body tail connection read-count samples",
    ),
    (
        "response_body_tail_connection_read_count_avg",
        "Response body tail connection read-count avg",
    ),
    (
        "response_body_tail_connection_read_count_p95",
        "Response body tail connection read-count p95",
    ),
    (
        "response_body_tail_connection_read_span_samples_total",
        "Response body tail connection read-span samples",
    ),
    (
        "response_body_tail_connection_read_span_avg_ms",
        "Response body tail connection read-span avg",
    ),
    (
        "response_body_tail_connection_read_span_p95_ms",
        "Response body tail connection read-span p95",
    ),
    (
        "response_body_tail_connection_last_read_to_end_samples_total",
        "Response body tail connection last-read-to-end samples",
    ),
    (
        "response_body_tail_connection_last_read_to_end_avg_ms",
        "Response body tail connection last-read-to-end avg",
    ),
    (
        "response_body_tail_connection_last_read_to_end_p95_ms",
        "Response body tail connection last-read-to-end p95",
    ),
    (
        "response_body_tail_connection_read_bytes_samples_total",
        "Response body tail connection read-byte samples",
    ),
    (
        "response_body_tail_connection_read_bytes_avg",
        "Response body tail connection read bytes avg",
    ),
    (
        "response_body_tail_connection_read_bytes_p95",
        "Response body tail connection read bytes p95",
    ),
    (
        "response_body_tail_connection_read_size_avg_samples_total",
        "Response body tail connection read-size samples",
    ),
    (
        "response_body_tail_connection_read_size_avg",
        "Response body tail connection read-size avg",
    ),
    (
        "response_body_tail_connection_read_size_p95",
        "Response body tail connection read-size p95",
    ),
    (
        "response_body_tail_connection_read_size_max_samples_total",
        "Response body tail connection max read-size samples",
    ),
    (
        "response_body_tail_connection_read_size_max_avg",
        "Response body tail connection max read-size avg",
    ),
    (
        "response_body_tail_connection_read_size_max_p95",
        "Response body tail connection max read-size p95",
    ),
    (
        "response_body_tail_connection_inter_read_gap_avg_samples_total",
        "Response body tail connection inter-read gap samples",
    ),
    (
        "response_body_tail_connection_inter_read_gap_avg_ms",
        "Response body tail connection inter-read gap avg",
    ),
    (
        "response_body_tail_connection_inter_read_gap_p95_ms",
        "Response body tail connection inter-read gap p95",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_samples_total",
        "Response body tail connection max inter-read gap samples",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_avg_ms",
        "Response body tail connection max inter-read gap avg",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_p95_ms",
        "Response body tail connection max inter-read gap p95",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_position_samples_total",
        "Response body tail connection max inter-read gap position samples",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_read_index_avg",
        "Response body tail connection max inter-read gap read-index avg",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_read_index_p95",
        "Response body tail connection max inter-read gap read-index p95",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_bytes_before_avg",
        "Response body tail connection max inter-read gap bytes-before avg",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_bytes_before_p95",
        "Response body tail connection max inter-read gap bytes-before p95",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_bytes_after_avg",
        "Response body tail connection max inter-read gap bytes-after avg",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_bytes_after_p95",
        "Response body tail connection max inter-read gap bytes-after p95",
    ),
    (
        "response_body_tail_connection_inter_read_gap_max_byte_position_ratio_avg",
        "Response body tail connection max inter-read gap byte-position ratio avg",
    ),
    (
...
SERVER_EMISSION_SUMMARY_KEYS = (
    ...
    (
        ...
        "Server request body second-chunk wait avg",
    ),
    (
        "request_body_drain_remaining_tail_read_avg_ms",
        "Server request body remaining tail-read avg",
    ),
    (
    ...
    (
        ...
        "Native request body reader total avg",
    ),
    (
        "native_request_body_reader_first_chunk_wait_avg_ms",
        "Native request body reader first-chunk wait avg",
    ),
    (
        "native_request_body_reader_second_chunk_wait_avg_ms",
        "Native request body reader second-chunk wait avg",
    ),
    (
        "native_request_body_reader_remaining_tail_read_avg_ms",
        "Native request body reader remaining tail-read avg",
    ),
    (
        "native_request_body_reader_remaining_tail_data_wait_avg_ms",
        "Native request body reader remaining tail data-wait avg",
    ),
    (
...
def render_phase_timing_focus_line(name: str, focus: dict | None) -> str:
    ...
    if connection_metric_snapshot_has_samples(
        metrics["response_headers_last_write_to_first_read_samples_total"]
    ):
        rendered += (
            f", response-header last-write-to-first-read samples "
            f"{render_connection_metric_snapshot(metrics['response_headers_last_write_to_first_read_samples_total'])}, "
            f"response-header last-write-to-first-read avg "
            f"{render_connection_metric_snapshot(metrics['response_headers_last_write_to_first_read_avg_ms'])}"
        )
    if connection_metric_snapshot_has_samples(
    ...
    if connection_metric_snapshot_has_samples(
        metrics["response_body_tail_connection_read_count_samples_total"]
    ):
        rendered += (
            f", tail connection read-count avg "
            f"{render_connection_metric_snapshot(metrics['response_body_tail_connection_read_count_avg'])}"
        )
    if connection_metric_snapshot_has_samples(
        metrics["response_body_tail_connection_read_span_samples_total"]
    ):
        rendered += (
            f", tail connection read-span avg "
            f"{render_connection_metric_snapshot(metrics['response_body_tail_connection_read_span_avg_ms'])}"
        )
    if connection_metric_snapshot_has_samples(
        metrics["response_body_tail_connection_last_read_to_end_samples_total"]
    ):
        rendered += (
            f", tail connection last-read-to-end avg "
            f"{render_connection_metric_snapshot(metrics['response_body_tail_connection_last_read_to_end_avg_ms'])}"
        )
    if connection_metric_snapshot_has_samples(
        metrics["response_body_tail_connection_read_bytes_samples_total"]
    ):
        rendered += (
            f", tail connection read bytes avg "
            f"{render_connection_metric_snapshot(metrics['response_body_tail_connection_read_bytes_avg'])}, "
            f"tail connection read-size avg "
            f"{render_connection_metric_snapshot(metrics['response_body_tail_connection_read_size_avg'])}, "
            f"tail connection max read-size avg "
            f"{render_connection_metric_snapshot(metrics['response_body_tail_connection_read_size_max_avg'])}"
        )
    if connection_metric_snapshot_has_samples(
        metrics["response_body_tail_connection_inter_read_gap_avg_samples_total"]
    ):
        rendered += (
            f", tail connection inter-read gap avg "
            f"{render_connection_metric_snapshot(metrics['response_body_tail_connection_inter_read_gap_avg_ms'])}, "
...
def render_server_emission_focus_line(name: str, focus: dict | None) -> str:
    ...
    return (
        ...
        f"server request body second-chunk wait avg "
        f"{render_connection_metric_snapshot(metrics['request_body_drain_second_chunk_wait_avg_ms'])}, "
        f"server request body remaining tail-read avg "
        f"{render_connection_metric_snapshot(metrics['request_body_drain_remaining_tail_read_avg_ms'])}, "
        ...
        f"native request body reader total avg "
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_total_avg_ms'])}, "
        f"native request body reader first-chunk wait avg "
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_first_chunk_wait_avg_ms'])}, "
        f"native request body reader second-chunk wait avg "
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_second_chunk_wait_avg_ms'])}, "
        f"native request body reader remaining tail-read avg "
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_remaining_tail_read_avg_ms'])}, "
        f"native request body reader remaining tail data-wait avg "
        ...
        f"native request body reader remaining tail max data-wait available window before avg "
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_remaining_tail_data_wait_max_available_capacity_before_avg'])}, "
        f"native request body reader remaining tail max data-wait used window before avg "
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_remaining_tail_data_wait_max_used_capacity_before_avg'])}, "
        f"native request body reader remaining tail max data-wait available window after data avg "
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_remaining_tail_data_wait_max_available_capacity_after_data_avg'])}, "
        f"native request body reader remaining tail max data-wait used window after data avg "
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_remaining_tail_data_wait_max_used_capacity_after_data_avg'])}, "
        f"native request body reader remaining tail max data-wait available window after release avg "
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_remaining_tail_data_wait_max_available_capacity_after_release_avg'])}, "
        f"native request body reader remaining tail max data-wait used window after release avg "
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_remaining_tail_data_wait_max_used_capacity_after_release_avg'])}, "
        ...
        f"{render_connection_metric_snapshot(metrics['native_request_body_reader_chunk_count_avg'])}."
    )
...
def render_markdown(comparison: dict) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            "| Workload | Router workers | Native runtime threads | Response headers wait avg ms | Header conn read samples | Header conn read wait avg ms | Header conn read-to-headers samples | Header conn read-to-headers avg ms | Header conn write samples | Header conn write wait avg ms | Header conn write-span samples | Header conn write-span avg ms | Header last-write-to-first-read samples | Header last-write-to-first-read avg ms | Response headers wait p95 ms |",
            "| --- | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |",
        ]
    )
    ...
    for row in rows:
        ...
        lines.append(
            "| {workload} | {router_workers} | {native_runtime_threads} | {response_headers_wait_avg_ms} | {response_headers_connection_read_wait_samples_total} | {response_headers_connection_read_wait_avg_ms} | {response_headers_connection_read_to_headers_samples_total} | {response_headers_connection_read_to_headers_avg_ms} | {response_headers_connection_write_wait_samples_total} | {response_headers_connection_write_wait_avg_ms} | {response_headers_connection_write_span_samples_total} | {response_headers_connection_write_span_avg_ms} | {response_headers_last_write_to_first_read_samples_total} | {response_headers_last_write_to_first_read_avg_ms} | {response_headers_wait_p95_ms} |".format(
                ...
                response_headers_last_write_to_first_read_samples_total=render_connection_metric_snapshot(
                    metrics["response_headers_last_write_to_first_read_samples_total"]
                ),
                response_headers_last_write_to_first_read_avg_ms=render_connection_metric_snapshot(
                    metrics["response_headers_last_write_to_first_read_avg_ms"]
                ),
    ...
    if not has_header_rows:
        lines.append(
            "| No HTTP header-receive metrics | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a |"
        )
    ...
    for row in rows:
        ...
        lines.append(
            "| {workload} | {router_workers} | {native_runtime_threads} | {response_body_first_chunk_wait_avg_ms} | {response_body_tail_read_avg_ms} | {response_body_chunk_count_avg} | {response_body_first_chunk_bytes_avg} | {response_body_post_header_connection_read_wait_samples_total} | {response_body_post_header_connection_read_wait_avg_ms} | {response_body_connection_read_to_first_chunk_samples_total} | {response_body_connection_read_to_first_chunk_avg_ms} | {response_body_tail_connection_read_wait_samples_total} | {response_body_tail_connection_read_wait_avg_ms} | {response_body_tail_connection_read_to_end_samples_total} | {response_body_tail_connection_read_to_end_avg_ms} | {response_body_tail_connection_read_count_avg} | {response_body_tail_connection_read_span_avg_ms} | {response_body_tail_connection_last_read_to_end_avg_ms} | {response_body_tail_connection_read_bytes_avg} | {response_body_tail_connection_read_size_avg} | {response_body_tail_connection_read_size_max_avg} | {response_body_tail_connection_inter_read_gap_avg_ms} | {response_body_tail_connection_inter_read_gap_max_avg_ms} | {response_body_tail_connection_inter_read_gap_max_read_index_avg} | {response_body_tail_connection_inter_read_gap_max_bytes_before_avg} | {response_body_tail_connection_inter_read_gap_max_bytes_after_avg} | {response_body_tail_connection_inter_read_gap_max_byte_position_ratio_avg} | {response_body_tail_connection_inter_read_gap_max_response_bytes_before_avg} | {response_body_tail_connection_inter_read_gap_max_response_byte_position_ratio_avg} | {response_body_tail_connection_inter_read_gap_max_response_chunk_offset_avg} | {response_body_tail_connection_inter_read_gap_max_response_chunk_boundary_distance_avg} | {response_body_read_p95_ms} |".format(
                ...
                response_body_tail_connection_read_count_avg=render_connection_metric_snapshot(
                    metrics["response_body_tail_connection_read_count_avg"]
                ),
                response_body_tail_connection_read_span_avg_ms=render_connection_metric_snapshot(
                    metrics["response_body_tail_connection_read_span_avg_ms"]
                ),
                response_body_tail_connection_last_read_to_end_avg_ms=render_connection_metric_snapshot(
                    metrics["response_body_tail_connection_last_read_to_end_avg_ms"]
                ),
                response_body_tail_connection_read_bytes_avg=render_connection_metric_snapshot(
                    metrics["response_body_tail_connection_read_bytes_avg"]
                ),
                response_body_tail_connection_read_size_avg=render_connection_metric_snapshot(
                    metrics["response_body_tail_connection_read_size_avg"]
                ),
                response_body_tail_connection_read_size_max_avg=render_connection_metric_snapshot(
                    metrics["response_body_tail_connection_read_size_max_avg"]
                ),
                response_body_tail_connection_inter_read_gap_avg_ms=render_connection_metric_snapshot(
                    metrics["response_body_tail_connection_inter_read_gap_avg_ms"]
                ),
                response_body_tail_connection_inter_read_gap_max_avg_ms=render_connection_metric_snapshot(
                    metrics["response_body_tail_connection_inter_read_gap_max_avg_ms"]
                ),
                response_body_tail_connection_inter_read_gap_max_read_index_avg=render_connection_metric_snapshot(
                    metrics[
                        "response_body_tail_connection_inter_read_gap_max_read_index_avg"
                    ]
                ),
                response_body_tail_connection_inter_read_gap_max_bytes_before_avg=render_connection_metric_snapshot(
                    metrics[
                        "response_body_tail_connection_inter_read_gap_max_bytes_before_avg"
                    ]
                ),
                response_body_tail_connection_inter_read_gap_max_bytes_after_avg=render_connection_metric_snapshot(
                    metrics[
                        "response_body_tail_connection_inter_read_gap_max_bytes_after_avg"
                    ]
                ),
    ...
    if not has_body_rows:
        lines.append(
            "| No HTTP response-body diagnostics | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a |"
        )
    ...
    for row in rows:
        ...
        lines.append(
            "| {workload} | {router_workers} | {native_runtime_threads} | {requests_total} | {synthetic_responses_total} | {headers_to_first_body_write_avg_ms} | {headers_to_first_body_write_completed_avg_ms} | {queue_to_first_body_write_avg_ms} | {queue_to_first_body_write_completed_avg_ms} | {first_body_write_avg_ms} | {first_body_write_completed_avg_ms} | {first_body_write_call_avg_ms} | {direct_stream_open_round_trip_avg_ms} | {direct_stream_request_queue_delay_avg_ms} | {direct_stream_descriptor_open_call_avg_ms} | {direct_stream_reply_delivery_delay_avg_ms} | {stream_open_avg_ms} | {request_body_drain_avg_ms} | {request_body_drain_first_chunk_wait_avg_ms} | {request_body_drain_tail_read_avg_ms} | {request_body_drain_second_chunk_wait_avg_ms} | {request_body_drain_remaining_tail_read_avg_ms} | {request_body_drain_chunk_count_avg} | {native_request_body_reader_total_avg_ms} | {native_request_body_reader_first_chunk_wait_avg_ms} | {native_request_body_reader_second_chunk_wait_avg_ms} | {native_request_body_reader_remaining_tail_read_avg_ms} | {native_request_body_reader_remaining_tail_data_wait_avg_ms} | {native_request_body_reader_remaining_tail_data_wait_max_avg_ms} | {native_request_body_reader_remaining_tail_data_wait_max_event_index_avg} | {native_request_body_reader_remaining_tail_data_wait_max_bytes_before_avg} | {native_request_body_reader_remaining_tail_data_wait_max_bytes_after_avg} | {native_request_body_reader_remaining_tail_data_wait_max_eof_ratio} | {native_request_body_reader_remaining_tail_data_wait_max_available_capacity_before_avg} | {native_request_body_reader_remaining_tail_data_wait_max_used_capacity_before_avg} | {native_request_body_reader_remaining_tail_data_wait_max_available_capacity_after_data_avg} | {native_request_body_reader_remaining_tail_data_wait_max_used_capacity_after_data_avg} | {native_request_body_reader_remaining_tail_data_wait_max_available_capacity_after_release_avg} | {native_request_body_reader_remaining_tail_data_wait_max_used_capacity_after_release_avg} | {native_request_body_reader_data_chunk_wait_avg_ms} | {native_request_body_reader_chunk_count_avg} |".format(
                ...
                request_body_drain_second_chunk_wait_avg_ms=render_connection_metric_snapshot(
                    metrics["request_body_drain_second_chunk_wait_avg_ms"]
                ),
                request_body_drain_remaining_tail_read_avg_ms=render_connection_metric_snapshot(
                    metrics["request_body_drain_remaining_tail_read_avg_ms"]
                ),
                request_body_drain_chunk_count_avg=render_connection_metric_snapshot(
                    metrics["request_body_drain_chunk_count_avg"]
                ),
                native_request_body_reader_total_avg_ms=render_connection_metric_snapshot(
                    metrics["native_request_body_reader_total_avg_ms"]
                ),
                native_request_body_reader_first_chunk_wait_avg_ms=render_connection_metric_snapshot(
                    metrics["native_request_body_reader_first_chunk_wait_avg_ms"]
                ),
                native_request_body_reader_second_chunk_wait_avg_ms=render_connection_metric_snapshot(
                    metrics["native_request_body_reader_second_chunk_wait_avg_ms"]
                ),
                native_request_body_reader_remaining_tail_read_avg_ms=render_connection_metric_snapshot(
                    metrics["native_request_body_reader_remaining_tail_read_avg_ms"]
                ),
                native_request_body_reader_remaining_tail_data_wait_avg_ms=render_connection_metric_snapshot(
                    metrics[
                        "native_request_body_reader_remaining_tail_data_wait_avg_ms"
                    ]
                ),
                native_request_body_reader_remaining_tail_data_wait_max_avg_ms=render_connection_metric_snapshot(
                    metrics[
                        "native_request_body_reader_remaining_tail_data_wait_max_avg_ms"
                    ]
                ),
                ...
                native_request_body_reader_remaining_tail_data_wait_max_available_capacity_before_avg=render_connection_metric_snapshot(
                    metrics[
                        "native_request_body_reader_remaining_tail_data_wait_max_available_capacity_before_avg"
                    ]
                ),
                native_request_body_reader_remaining_tail_data_wait_max_used_capacity_before_avg=render_connection_metric_snapshot(
                    metrics[
                        "native_request_body_reader_remaining_tail_data_wait_max_used_capacity_before_avg"
                    ]
                ),
                native_request_body_reader_remaining_tail_data_wait_max_available_capacity_after_data_avg=render_connection_metric_snapshot(
                    metrics[
                        "native_request_body_reader_remaining_tail_data_wait_max_available_capacity_after_data_avg"
                    ]
                ),
                native_request_body_reader_remaining_tail_data_wait_max_used_capacity_after_data_avg=render_connection_metric_snapshot(
                    metrics[
                        "native_request_body_reader_remaining_tail_data_wait_max_used_capacity_after_data_avg"
                    ]
                ),
                native_request_body_reader_remaining_tail_data_wait_max_available_capacity_after_release_avg=render_connection_metric_snapshot(
                    metrics[
                        "native_request_body_reader_remaining_tail_data_wait_max_available_capacity_after_release_avg"
                    ]
                ),
                native_request_body_reader_remaining_tail_data_wait_max_used_capacity_after_release_avg=render_connection_metric_snapshot(
                    metrics[
                        "native_request_body_reader_remaining_tail_data_wait_max_used_capacity_after_release_avg"
                    ]
                ),
                ...
                native_request_body_reader_chunk_count_avg=render_connection_metric_snapshot(
                    metrics["native_request_body_reader_chunk_count_avg"]
                ),
            )
        )
    ...
    if not has_server_emission_rows:
        lines.append(
            "| No HTTP server emission metrics | " + " | ".join(["n/a"] * 40) + " |"
        )
