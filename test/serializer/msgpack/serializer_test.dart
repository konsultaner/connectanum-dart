...
void main() {
  ...
  group('deserialize', () {
    test('Abort', () {
      ...
      var abort = serializer.deserialize(toDeserialize as Uint8List) as Abort?;
    ...
    test('Error', () {
      ...
      var err = serializer.deserialize(toDeserialize as Uint8List) as Error?;
      ...
      err = serializer.deserialize(toDeserialize as Uint8List) as Error?;
      expect(err, isNotNull);
      expect(err!.id, equals(MessageTypes.CODE_ERROR));
      expect(err.details, isNotNull);
    ...
    test('Goodbye', () {
      ...
      var goodbye = serializer.deserialize(toDeserialize as Uint8List) as Goodbye?;
  ...
  group('string conversion', () {
    test('convert UTF-8', () {
      ...
      var deserializedInvocation =
          serializer.deserialize(serializer.serialize(invocation) as Uint8List) as Invocation?;
