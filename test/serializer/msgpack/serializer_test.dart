...
void main() {
  ...
  group('serialize', () {
    test('Hello', () {
      expect(
          ...
          equals(Uint8List.fromList([
            147, 1, 168, 109, 121, 46, 114, 101, 97, 108, 109, 129, 165, 114, //
            111, 108, 101, 115, 132, 166, 99, 97, 108, 108, 101, 114, 129, //
            168, 102, 101, 97, 116, 117, 114, 101, 115, 133, 174, 99, 97, //
            108, 108, 95, 99, 97, 110, 99, 101, 108, 105, 110, 103, 194, //
            172, 99, 97, 108, 108, 95, 116, 105, 109, 101, 111, 117, 116, //
            194, 181, 99, 97, 108, 108, 101, 114, 95, 105, 100, 101, 110, //
            116, 105, 102, 105, 99, 97, 116, 105, 111, 110, 195, 180, 112, //
            97, 121, 108, 111, 97, 100, 95, 116, 114, 97, 110, 115, 112, 97, //
            114, 101, 110, 99, 121, 195, 184, 112, 114, 111, 103, 114, 101, //
            115, 115, 105, 118, 101, 95, 99, 97, 108, 108, 95, 114, 101, 115, //
            117, 108, 116, 115, 195, 166, 99, 97, 108, 108, 101, 101, 129, //
            168, 102, 101, 97, 116, 117, 114, 101, 115, 136, 181, 99, 97, //
            108, 108, 101, 114, 95, 105, 100, 101, 110, 116, 105, 102, 105, //
            99, 97, 116, 105, 111, 110, 195, 176, 99, 97, 108, 108, 95, 116, //
            114, 117, 115, 116, 108, 101, 118, 101, 108, 115, 194, 186, 112, //
            97, 116, 116, 101, 114, 110, 95, 98, 97, 115, 101, 100, 95, 114, //
            101, 103, 105, 115, 116, 114, 97, 116, 105, 111, 110, 194, 179, //
            115, 104, 97, 114, 101, 100, 95, 114, 101, 103, 105, 115, 116, //
            114, 97, 116, 105, 111, 110, 194, 174, 99, 97, 108, 108, 95, 99, //
            97, 110, 99, 101, 108, 105, 110, 103, 194, 172, 99, 97, 108, 108, //
            95, 116, 105, 109, 101, 111, 117, 116, 194, 180, 112, 97, 121, //
            108, 111, 97, 100, 95, 116, 114, 97, 110, 115, 112, 97, 114, 101, //
            110, 99, 121, 195, 184, 112, 114, 111, 103, 114, 101, 115, 115, //
            105, 118, 101, 95, 99, 97, 108, 108, 95, 114, 101, 115, 117, 108, //
            ...
            116, 194, 180, 112, 97, 121, 108, 111, 97, 100, 95, 116, 114, //
            97, 110, 115, 112, 97, 114, 101, 110, 99, 121, 195, 184, 112, //
            114, 111, 103, 114, 101, 115, 115, 105, 118, 101, 95, 99, 97, //
            108, 108, 95, 114, 101, 115, 117, 108, 116, 115, 194, 183, 115, //
            117, 98, 115, 99, 114, 105, 112, 116, 105, 111, 110, 95, 114, //
            101, 118, 111, 99, 97, 116, 105, 111, 110, 195, 169, 112, 117, //
            98, 108, 105, 115, 104, 101, 114, 129, 168, 102, 101, 97, 116, //
            117, 114, 101, 115, 132, 184, 112, 117, 98, 108, 105, 115, 104, //
            101, 114, 95, 105, 100, 101, 110, 116, 105, 102, 105, 99, 97, //
            116, 105, 111, 110, 195, 189, 115, 117, 98, 115, 99, 114, 105, //
            98, 101, 114, 95, 98, 108, 97, 99, 107, 119, 104, 105, 116, 101, //
            95, 108, 105, 115, 116, 105, 110, 103, 195, 179, 112, 117, 98, //
            108, 105, 115, 104, 101, 114, 95, 101, 120, 99, 108, 117, 115, //
            105, 111, 110, 195, 180, 112, 97, 121, 108, 111, 97, 100, 95, //
            116, 114, 97, 110, 115, 112, 97, 114, 101, 110, 99, 121, 195 //
          ])));
      expect(
          serializer.serialize(Hello(null, Details.forHello())),
            87, 65, 77, 80, 45, 67, 82, 65, 169, 97, 117, 116, 104, 101, //
            120, 116, 114, 97, 130, 175, 99, 104, 97, 110, 110, 101, 108, //
            95, 98, 105, 110, 100, 105, 110, 103, 192, 165, 110, 111, 110, //
            99, 101, 172, 101, 103, 86, 68, 102, 51, 68, 77, 74, 104, 48, 61 //
          ]));
    });
    test('Authenticate', () {
    ...
    test('Register', () {
      expect(
          ...
          equals(Uint8List.fromList([
            148, MessageTypes.codeRegister, 206, 1, 130, 204, 65, 128, 182,
            99, //
      ...
      expect(
          ...
          equals(Uint8List.fromList([
            148, MessageTypes.codeRegister, 206, 1, 130, 204, 65, 131, 165, //
      ...
      expect(
          ...
          equals(Uint8List.fromList([
            148, MessageTypes.codeRegister, 206, 1, 130, 204, 65, 129, 175, //
    ...
    test('Unregister', () {
      expect(
          ...
          equals(Uint8List.fromList([
            147, MessageTypes.codeUnregister, 206, 1, 130, 204, 65, 206, 7, //
            160, 214, 180
          ])));
    });
    test('Call', () {
      ...
      expect(
          ...
          equals(Uint8List.fromList([
            148, MessageTypes.codeCall, 206, 0, 119, 59, 247, 131, 176, 114, //
      ...
      expect(
          ...
          equals(Uint8List.fromList([
            149, MessageTypes.codeCall, 206, 0, 119, 59, 247, 128, 174, 99, //
            111, 109, 46, 109, 121, 97, 112, 112, 46, 112, //
      ...
      expect(
          ...
          equals(Uint8List.fromList([
            150, MessageTypes.codeCall, 206, 0, 119, 59, 247, 128, 174, //
      ...
      expect(
          ...
          equals(Uint8List.fromList([
            150, MessageTypes.codeCall, 206, 0, 119, 59, 247, 128, 174, 99,
            111, 109, 46, 109, //
    ...
    test('Yield', () {
      expect(
          ...
          equals(Uint8List.fromList(
              [147, MessageTypes.codeYield, 206, 0, 93, 143, 77, 128, 160])));
      expect(
      ...
      expect(
          ...
          equals(Uint8List.fromList([
            148, MessageTypes.codeYield, 206, 0, 93, 143, 77, 128, 146, 162, //
            104, 105, 2
          ])));
      expect(
          serializer.serialize(Yield(6131533, argumentsKeywords: {'hi': 12})),
          equals(Uint8List.fromList([
            149, MessageTypes.codeYield, 206, 0, 93, 143, 77, 128, 144, //
            129, 162, 104, 105, 12
          ])));
      expect(
          serializer.serialize(Yield(6131533,
              arguments: ['hi', 2], argumentsKeywords: {'hi': 12})),
          equals(Uint8List.fromList([
            149, MessageTypes.codeYield, 206, 0, 93, 143, 77, 128, 146, 162, //
    ...
    test('Error', () {
      ...
      expect(
          serializer.serialize(Error(MessageTypes.codeHello, 123422,
              ...
              arguments: ['hi', 2])),
          equals(Uint8List.fromList([
            150, MessageTypes.codeError, MessageTypes.codeHello, 206, 0, 1,
            226, 30, 129, 165, //
            99, 97, 117, 115, 101, 164, 115, 111, 109, 101, //
            172, 119, 97, 109, 112, 46, 117, 110, 107, 110, //
      ...
      expect(
          ...
          equals(Uint8List.fromList([
            151, MessageTypes.codeError, MessageTypes.codeHello, 206, 0, //
      ...
      expect(
          serializer.serialize(Error(MessageTypes.codeHello, 123422,
              ...
              arguments: ['hi', 2], argumentsKeywords: {'hi': 12})),
          equals(Uint8List.fromList([
            151, MessageTypes.codeError, MessageTypes.codeHello, 206, 0, 1, //
  ...
  group('deserialize', () {
    test('Abort', () {
      var toDeserialize = serializer.serialize(Abort(Error.protocolViolation,
    ...
    test('Error', () {
      ...
      expect(err.id, equals(MessageTypes.codeError));
      expect(err.details, isNotNull);

      toDeserialize = serializer.serialize(Error(
          MessageTypes.codeHello, 678887, {}, Error.invalidArgument,
    ...
    test('Goodbye', () {
      ...
      expect(goodbye.id, MessageTypes.codeGoodbye);
      expect(goodbye.message!.message, equals('bye bye ms american pie'));
      expect(goodbye.reason, equals(Goodbye.reasonGoodbyeAndOut));
    });
  });
