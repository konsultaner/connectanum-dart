...
fn summarize_http_phase_timing(
    ...
    Some(HttpPhaseTimingSummary {
        ...
        response_body_tail_connection_read_count_avg: if response_body_tail_connection_read_counts
            .is_empty()
        {
            0.0
        } else {
        ...
        response_body_tail_connection_read_count_p95: if response_body_tail_connection_read_counts
            .is_empty()
        {
            0.0
        } else {
        ...
        response_body_tail_connection_read_span_avg_ms: if response_body_tail_connection_read_spans
            .is_empty()
        {
            0.0
        } else {
        ...
        response_body_tail_connection_read_span_p95_ms: if response_body_tail_connection_read_spans
            .is_empty()
        {
            0.0
        } else {
        ...
        response_body_tail_connection_inter_read_gap_max_bytes_before_avg:
            if response_body_tail_connection_inter_read_gap_max_bytes_befores.is_empty() {
                ...
                response_body_tail_connection_inter_read_gap_max_bytes_befores
                    .iter()
                    .sum::<f64>()
                    / response_body_tail_connection_inter_read_gap_max_bytes_befores.len() as f64
            },
        ...
        response_body_tail_connection_inter_read_gap_max_byte_position_ratio_avg:
            if response_body_tail_connection_inter_read_gap_max_byte_position_ratios.is_empty() {
                ...
                response_body_tail_connection_inter_read_gap_max_byte_position_ratios
                    .iter()
                    .sum::<f64>()
                    / response_body_tail_connection_inter_read_gap_max_byte_position_ratios.len()
                        as f64
            },
...
fn summarize_http_server_emission_timing(
    ...
    .unwrap_or(0)
    .max(0) as u64;
    let request_body_drain_second_chunk_wait_samples_total = bench_http_stream_counter_delta(
        &report.metrics_before,
        &report.metrics_after,
    ...
    .unwrap_or(0)
    .max(0) as u64;
    let request_body_drain_remaining_tail_read_samples_total = bench_http_stream_counter_delta(
        &report.metrics_before,
        &report.metrics_after,
    ...
    .unwrap_or(0)
    .max(0) as u64;
    let request_body_drain_second_chunk_wait_us_total = bench_http_stream_counter_delta(
        &report.metrics_before,
        &report.metrics_after,
    ...
    .unwrap_or(0)
    .max(0) as u64;
    let request_body_drain_remaining_tail_read_us_total = bench_http_stream_counter_delta(
        &report.metrics_before,
        &report.metrics_after,
    ...
    Some(HttpServerEmissionTimingSummary {
        ...
        request_body_drain_second_chunk_wait_avg_ms: average_microseconds_to_millis(
            request_body_drain_second_chunk_wait_us_total,
            request_body_drain_second_chunk_wait_samples_total,
        ),
        request_body_drain_remaining_tail_read_avg_ms: average_microseconds_to_millis(
            request_body_drain_remaining_tail_read_us_total,
            request_body_drain_remaining_tail_read_samples_total,
        ),
...
fn summarize_http_native_response_stream_timing(
    ...
    .unwrap_or(0)
    .max(0) as u64;
    let tail_chunk_channel_wait_samples_total = transport_http_response_stream_counter_delta(
        &report.metrics_before,
        &report.metrics_after,
    ...
    .unwrap_or(0)
    .max(0) as u64;
    let tail_chunk_channel_wait_us_total = transport_http_response_stream_counter_delta(
        &report.metrics_before,
        &report.metrics_after,
    ...
    .unwrap_or(0)
    .max(0) as u64;
    let tail_chunk_send_call_samples_total = transport_http_response_stream_counter_delta(
        &report.metrics_before,
        &report.metrics_after,
    ...
    .unwrap_or(0)
    .max(0) as u64;
    let tail_chunk_send_call_us_total = transport_http_response_stream_counter_delta(
        &report.metrics_before,
        &report.metrics_after,
    ...
    .unwrap_or(0)
    .max(0) as u64;
    let first_to_last_chunk_send_samples_total = transport_http_response_stream_counter_delta(
        &report.metrics_before,
        &report.metrics_after,
    ...
    .unwrap_or(0)
    .max(0) as u64;
    let first_to_last_chunk_send_us_total = transport_http_response_stream_counter_delta(
        &report.metrics_before,
        &report.metrics_after,
    ...
    Some(HttpNativeResponseStreamTimingSummary {
        ...
        tail_chunk_channel_wait_avg_ms: average_microseconds_to_millis(
            tail_chunk_channel_wait_us_total,
            tail_chunk_channel_wait_samples_total,
        ),
        tail_chunk_send_call_avg_ms: average_microseconds_to_millis(
            tail_chunk_send_call_us_total,
            tail_chunk_send_call_samples_total,
        ),
        first_to_last_chunk_send_avg_ms: average_microseconds_to_millis(
            first_to_last_chunk_send_us_total,
            first_to_last_chunk_send_samples_total,
        ),
    })
...
fn summarize_http_native_response_stream_slow_path(
    ...
    Some(HttpNativeResponseStreamSlowPathSummary {
        ...
        .unwrap_or(0)
        .max(0) as u64,
        tail_chunk_channel_wait_ge_1ms_total: transport_http_response_stream_counter_delta(
            &report.metrics_before,
            &report.metrics_after,
        ...
        .unwrap_or(0)
        .max(0) as u64,
        tail_chunk_channel_wait_ge_5ms_total: transport_http_response_stream_counter_delta(
            &report.metrics_before,
            &report.metrics_after,
        ...
        .unwrap_or(0)
        .max(0) as u64,
        tail_chunk_channel_wait_ge_10ms_total: transport_http_response_stream_counter_delta(
            &report.metrics_before,
            &report.metrics_after,
        ...
        .unwrap_or(0)
        .max(0) as u64,
        tail_chunk_send_call_ge_1ms_total: transport_http_response_stream_counter_delta(
            &report.metrics_before,
            &report.metrics_after,
        ...
        .unwrap_or(0)
        .max(0) as u64,
        tail_chunk_send_call_ge_5ms_total: transport_http_response_stream_counter_delta(
            &report.metrics_before,
            &report.metrics_after,
        ...
        .unwrap_or(0)
        .max(0) as u64,
        tail_chunk_send_call_ge_10ms_total: transport_http_response_stream_counter_delta(
            &report.metrics_before,
            &report.metrics_after,
        ...
        .unwrap_or(0)
        .max(0) as u64,
        first_to_last_chunk_send_ge_1ms_total: transport_http_response_stream_counter_delta(
            &report.metrics_before,
            &report.metrics_after,
        ...
        .unwrap_or(0)
        .max(0) as u64,
        first_to_last_chunk_send_ge_5ms_total: transport_http_response_stream_counter_delta(
            &report.metrics_before,
            &report.metrics_after,
        ...
        .unwrap_or(0)
        .max(0) as u64,
        first_to_last_chunk_send_ge_10ms_total: transport_http_response_stream_counter_delta(
            &report.metrics_before,
            &report.metrics_after,
...
mod tests {
            ...
            metrics_before: metrics_with_bench_http_stream(
                ...
                json!({
                    ...
                    "http_response_stream": {
                        ...
                        "tail_chunk_channel_wait_samples_total": 4,
                        "tail_chunk_channel_wait_us_total": 8000,
                        "tail_chunk_channel_wait_ge_1ms_total": 4,
                        "tail_chunk_channel_wait_ge_5ms_total": 1,
                        "tail_chunk_channel_wait_ge_10ms_total": 0,
                        "tail_chunk_send_call_samples_total": 4,
                        "tail_chunk_send_call_us_total": 2000,
                        "tail_chunk_send_call_ge_1ms_total": 1,
                        "tail_chunk_send_call_ge_5ms_total": 0,
                        "tail_chunk_send_call_ge_10ms_total": 0,
                        "first_to_last_chunk_send_samples_total": 2,
                        "first_to_last_chunk_send_us_total": 6000,
                        "first_to_last_chunk_send_ge_1ms_total": 2,
                ...
                Some(json!({
                    ...
                    "request_body_drain_second_chunk_wait_samples_total": 2,
                    "request_body_drain_second_chunk_wait_us_total": 1200,
                    "request_body_drain_remaining_tail_read_samples_total": 2,
                    "request_body_drain_remaining_tail_read_us_total": 1800,
            ...
            metrics_after: metrics_with_bench_http_stream(
                ...
                json!({
                    ...
                    "http_response_stream": {
                        ...
                        "tail_chunk_channel_wait_samples_total": 13,
                        "tail_chunk_channel_wait_us_total": 35000,
                        "tail_chunk_channel_wait_ge_1ms_total": 13,
                        "tail_chunk_channel_wait_ge_5ms_total": 4,
                        "tail_chunk_channel_wait_ge_10ms_total": 1,
                        "tail_chunk_send_call_samples_total": 13,
                        "tail_chunk_send_call_us_total": 7000,
                        "tail_chunk_send_call_ge_1ms_total": 3,
                        "tail_chunk_send_call_ge_5ms_total": 1,
                        "tail_chunk_send_call_ge_10ms_total": 0,
                        "first_to_last_chunk_send_samples_total": 5,
                        "first_to_last_chunk_send_us_total": 27000,
                ...
                Some(json!({
                    ...
                    "request_body_drain_second_chunk_wait_samples_total": 5,
                    "request_body_drain_second_chunk_wait_us_total": 4200,
                    "request_body_drain_remaining_tail_read_samples_total": 5,
                    "request_body_drain_remaining_tail_read_us_total": 4800,
            ...
            samples: vec![
                WorkloadSample {
                    ...
                    http_phase_timing: Some(HttpPhaseTimingSample {
                        ...
                        response_body_tail_connection_inter_read_gap_max_read_index: Some(2),
                        response_body_tail_connection_inter_read_gap_max_bytes_before: Some(512),
                        response_body_tail_connection_inter_read_gap_max_bytes_after: Some(512),
                        response_body_tail_connection_inter_read_gap_max_byte_position_ratio: Some(
                            0.5,
                        ),
                ...
                WorkloadSample {
                    ...
                    http_phase_timing: Some(HttpPhaseTimingSample {
                        ...
                        response_body_tail_connection_inter_read_gap_max_read_index: Some(3),
                        response_body_tail_connection_inter_read_gap_max_bytes_before: Some(2048),
                        response_body_tail_connection_inter_read_gap_max_bytes_after: Some(2048),
                        response_body_tail_connection_inter_read_gap_max_byte_position_ratio: Some(
                            0.5,
                        ),
                ...
                WorkloadSample {
                    ...
                    http_phase_timing: Some(HttpPhaseTimingSample {
                        ...
                        response_body_tail_connection_inter_read_gap_max_read_index: None,
                        response_body_tail_connection_inter_read_gap_max_bytes_before: None,
                        response_body_tail_connection_inter_read_gap_max_bytes_after: None,
                        response_body_tail_connection_inter_read_gap_max_byte_position_ratio: None,
    ...
    fn summarize_report_computes_latency_and_deltas() {
        ...
        assert_eq!(
            phase_timing.response_body_tail_connection_read_count_samples_total,
            2
        );
        assert!(
            (phase_timing.response_body_tail_connection_read_count_avg - 3.0).abs() < f64::EPSILON
        );
        assert!(
            (phase_timing.response_body_tail_connection_read_count_p95 - 4.0).abs() < f64::EPSILON
        );
        assert_eq!(
            phase_timing.response_body_tail_connection_read_span_samples_total,
            2
        );
        assert!(
            (phase_timing.response_body_tail_connection_read_span_avg_ms - 1.5).abs()
                < f64::EPSILON
        );
        assert!(
            (phase_timing.response_body_tail_connection_read_span_p95_ms - 2.0).abs()
                < f64::EPSILON
        );
        assert_eq!(
            phase_timing.response_body_tail_connection_last_read_to_end_samples_total,
            2
        );
        assert!(
            (phase_timing.response_body_tail_connection_last_read_to_end_avg_ms - 1.0).abs()
                < f64::EPSILON
        );
        assert!(
        ...
        assert_eq!(
            phase_timing.response_body_tail_connection_inter_read_gap_max_position_samples_total,
            2
        );
        assert!(
            (phase_timing.response_body_tail_connection_inter_read_gap_max_read_index_avg - 2.5)
                .abs()
                < f64::EPSILON
        );
        assert!(
            (phase_timing.response_body_tail_connection_inter_read_gap_max_read_index_p95 - 3.0)
                .abs()
                < f64::EPSILON
        );
        assert!(
            (phase_timing.response_body_tail_connection_inter_read_gap_max_bytes_before_avg
                - 1280.0)
                .abs()
                < f64::EPSILON
        );
        assert!(
            (phase_timing.response_body_tail_connection_inter_read_gap_max_bytes_before_p95
                - 2048.0)
                .abs()
                < f64::EPSILON
        );
        assert!(
            (phase_timing.response_body_tail_connection_inter_read_gap_max_bytes_after_avg
                - 1280.0)
                .abs()
                < f64::EPSILON
        );
        assert!(
            (phase_timing.response_body_tail_connection_inter_read_gap_max_bytes_after_p95
                - 2048.0)
                .abs()
                < f64::EPSILON
        );
        assert!(
            (phase_timing.response_body_tail_connection_inter_read_gap_max_byte_position_ratio_avg
                - 0.5)
                .abs()
                < f64::EPSILON
        );
        ...
        assert!(
            (server_timing.request_body_drain_second_chunk_wait_avg_ms - 1.0).abs() < f64::EPSILON
        );
        assert!(
            (server_timing.request_body_drain_remaining_tail_read_avg_ms - 1.0).abs()
                < f64::EPSILON
        );
        ...
        assert!((native_stream_timing.tail_chunk_channel_wait_avg_ms - 3.0).abs() < f64::EPSILON);
        assert!(
            (native_stream_timing.tail_chunk_send_call_avg_ms - (5.0 / 9.0)).abs() < f64::EPSILON
        );
        assert!((native_stream_timing.first_to_last_chunk_send_avg_ms - 7.0).abs() < f64::EPSILON);
        ...
        assert_eq!(
            native_stream_slow_path.tail_chunk_channel_wait_ge_5ms_total,
            3
        );
        assert_eq!(
            native_stream_slow_path.tail_chunk_channel_wait_ge_10ms_total,
            1
        );
        assert_eq!(native_stream_slow_path.tail_chunk_send_call_ge_1ms_total, 2);
        assert_eq!(native_stream_slow_path.tail_chunk_send_call_ge_5ms_total, 1);
        assert_eq!(
            native_stream_slow_path.tail_chunk_send_call_ge_10ms_total,
            0
        );
        assert_eq!(
            native_stream_slow_path.first_to_last_chunk_send_ge_1ms_total,
            3
        );
        assert_eq!(
            native_stream_slow_path.first_to_last_chunk_send_ge_5ms_total,
            3
        );
        assert_eq!(
            native_stream_slow_path.first_to_last_chunk_send_ge_10ms_total,
            1
        );
